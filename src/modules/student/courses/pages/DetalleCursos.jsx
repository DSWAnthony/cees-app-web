  ...
  return (
    <div className="p-6 max-w-6xl mx-auto bg-white min-h-screen">
      ...
      <div className="bg-gray-50 p-6 rounded-lg shadow-md">
        ...
        <section>
          <h2 className="text-md font-semibold text-gray-700 mb-2">Material de la clase</h2>
          ...
          <div className="w-full">
            {/* Cuadro oscuro superior */}
            <div className="w-full h-[80px] bg-gray-800 rounded-t" />

            {/* Cuadro gris claro inferior pegado */}
            <div className="w-full h-[500px] bg-gray-300 rounded-b" />
          </div>
        </section>
      </div>
    </div>
